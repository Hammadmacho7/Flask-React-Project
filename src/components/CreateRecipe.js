...
export default function CreateRecipe() {
  ...
  return (
    <div className='container'>
      ...
      <form>
        <Form.Group>
          <Form.Label className='makewhite'>Title</Form.Label>
        ...
        <Form.Group>
          <Form.Label className='makewhite'>Description</Form.Label>
        ...
        <br></br>
        <Form.Group>
          <Button variant="primary" onClick={handleSubmit(createRecipe)}>Submit</Button>
        </Form.Group>
      </form>
    </div>
  )
